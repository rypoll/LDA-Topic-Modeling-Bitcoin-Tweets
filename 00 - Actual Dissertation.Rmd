...
```{r echo=FALSE, fig.cap = "A toy example of a bag of words matrix", out.width='100%', fig.asp=0.4}
...
```{r lsa_svd, echo=FALSE, fig.cap = "Singular Value Decomposition of the TF", out.width='100%', fig.asp=0.4, fig.align="center"}
...
```{r plot1, echo=FALSE, fig.cap="Example of a multinomial distribution of the Topics in LDA for a single document.", out.width = '50%', fig.align="center"}
...
```{r betadist, echo=FALSE, fig.cap="The beta distribution with different parameters", out.width = '100%', fig.align="center"}
...
```{r dirivis2, echo=FALSE, fig.cap="How the probabiliy distribution for the Dirichlet changes with varying values of alpha", out.width = '100%', fig.align="center"}
